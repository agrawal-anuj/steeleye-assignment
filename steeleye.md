...
iii) It should be `arrayOf` and `shape` instead of `array` and `shapeOf` respectively
...
If we don't to store any value, below is the implementation
```javascript
//updated code
WrappedListComponent.defaultProps = {
